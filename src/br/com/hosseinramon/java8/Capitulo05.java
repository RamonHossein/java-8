...
public class Capitulo05 {
	...
	public static void main(String ... args) {
		...
		Usuario user3 = new Usuario("Guilherme Silveira", 190);
 		...
 		// Ordenar os usuário de forma alfabética - versão 1
		Comparator<Usuario> comparator1 = new Comparator<Usuario>() {
 		...
 		// Ordenar os usuário de forma alfabética - versão 2
		Comparator<Usuario> comparator2 = (u1, u2) -> u1.getNome().compareTo(u2.getNome());

 		Collections.sort(usuarios, comparator2);

 		// Ordenar os usuário de forma alfabética - versão 3
		Collections.sort(usuarios, (u1, u2) -> u1.getNome().compareTo(u2.getNome()));

 		// Ordenar os usuário de forma alfabética - versão 4
		usuarios.sort((u1, u2) -> u1.getNome().compareTo(u2.getNome()));

 		// Ordenar os usuário de forma alfabética - versão 5
		Comparator<Usuario> comparator3 = Comparator.comparing(u -> u.getNome());

 		usuarios.sort(comparator3);

 		// Ordenar os usuário de forma alfabética - versão 6
		usuarios.sort(Comparator.comparing(u -> u.getNome()));

 		// Ordenar os usuário de forma alfabética << Ordem natural >>
		List<String> palavras = Arrays.asList("Casa do Codigo", "Alura", "Caelum");

 		palavras.sort(Comparator.naturalOrder());

 		// Ordenar os usuário de forma alfabética << Ordem reversa >>
		palavras.sort(Comparator.reverseOrder());

 		// Ordenar os usuário por pontos - versão 1
		Function<Usuario, Integer> extraiPontos1 = u -> u.getPontos();
 		...
 		// Ordenar os usuário por pontos - versão 2
		usuarios.sort(Comparator.comparing(u -> u.getPontos()));

 		// Ordenar os usuário por pontos - versão 3
		ToIntFunction<Usuario> extraiPontos2 = u -> u.getPontos();
 		...
 		// Ordenar os usuário por pontos - versão 4
