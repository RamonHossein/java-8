...
public class Capitulo09 {
	...
	public static void main(String ... args) throws IOException {
		...
		LongStream lines1 = Files.list(Paths.get("./src/br/com/hosseinramon/java8"))
				.filter(p -> p.toString().endsWith(".java"))
				.mapToLong(p -> lines(p).count());
		
		// Retorna a quantidade de linhas de cada arquivo em uma List<Long>
		List<Long> lines2 = Files.list(Paths.get("./src/br/com/hosseinramon/java8"))
				.filter(p -> p.toString().endsWith(".java"))
				.map(p -> lines(p).count())
				.collect(Collectors.toList());
		
		// Retorna e imprimi a quantidade de linhas de cada arquivo em um Map<Path, Long> - versão 1
		...
		// Retorna e imprimi a quantidade de linhas de cada arquivo em um Map<Path, Long> - versão 2
		Map<Path, Long> linesPerFile2 = Files.list(Paths.get("./src/br/com/hosseinramon/java8"))
				.filter(p -> p.toString().endsWith(".java"))
		...
		Map<Path, List<String>> content = Files.list(Paths.get("./src/br/com/hosseinramon/java8"))
				.filter(p -> p.toString().endsWith(".java"))
		...
		// Imprimi um mapa de pontuação por usuários com aquela pontuação - versão 1
		...
		// Imprimi um mapa de pontuação por usuários com aquela pontuação - versão 2
		...
		// Imprimi um mapa de pontuação por usuários com aquela pontuação - versão 3
		...
		// Imprimi todos os usuários particionados entre moderadores e não moderadores
		...
		// Imprimi o nome de usuários particionados entre moderadores e não moderadores
		...
		// Imprimi a soma dos pontos particionados entre moderadores e não moderadores
		...
		// Retorna usuários com mais de 100 pontos e ordenados - versão 1
		List<Usuario> filtradosOrdenados1 = usuarios.stream()
				.filter(u -> u.getPontos() > 100)
				.sorted(Comparator.comparing(Usuario::getNome))
				.collect(Collectors.toList());
		
		// Retorna usuários com mais de 100 pontos e ordenados - versão 2
		List<Usuario> filtradosOrdenados2 = usuarios.parallelStream()
				.filter(u -> u.getPontos() > 100)
				.sorted(Comparator.comparing(Usuario::getNome))
				.collect(Collectors.toList());
		
		// Soma os números pares de 0 à 1.000.000.000
